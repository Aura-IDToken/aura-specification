...
**Review date:** 2026-08-20 (reconciled by DQ-006 CLOSURE RECONCILIATION; canonical-serialization
row closed by DQ-006 CLOSURE INTEGRATION — authority:
...
| Canonical serialization | APS-200 §8 binds RFC 8785 JCS, UTF-8 canonical bytes and the SHA-256 / RFC 6962 domains; DQ-006 CLOSED on CANONICAL-001 + CANONICAL-002 | **CLOSED** | APS-200 entity schemas (separate item) |
...
| RI-PY / RI-RS equality | PASS on CANONICAL-001 and on the JCS-discriminating CANONICAL-002 (bytes, SHA-256, RFC 6962 leaf); evidence published but unmerged | PARTIAL — canonicalization boundary closed, corpus incomplete | Merge evidence to default branches (C-1) + full APS-500 corpus |
